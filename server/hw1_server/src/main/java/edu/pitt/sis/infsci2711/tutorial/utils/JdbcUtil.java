...
public class JdbcUtil {
	...
	public static final String DEFAULT_USER = "fujun"; //CHANGE TO YOUR MYSQL USER NAME
	
	public static final String DEFAULT_PASSWOD = "0701"; // CHANGE TO YOUR MYSQL PASSWORD
